...
import profilepicture from "../img/profil copie.png";
...
import { FiBox, FiGithub, FiInstagram, FiLink, FiLinkedin, FiMail, FiMenu, FiPhoneCall } from "react-icons/fi";
...
export const headerIntroData = {
  title: {
    de: "Hi, I'm Achraf",
    en: "Salut, C'est Achraf",
  },
  subtitle: "Graphic designer ",
  description: {
    de: "I’m Achraf Souissi, a graphic designer based in Mohammedia, Morocco. I specialize in branding, packaging, restaurant menus, roll-ups, social media visuals, and artistic merchandise. I’m committed to creating unique and impactful designs that bring your ideas to life.",
    en: "Je suis Achraf Souissi, graphiste basé à Mohammedia, Maroc. Spécialisé dans le branding, le packaging, les menus de restaurants, les roll-ups, les visuels pour les réseaux sociaux et les articles artistiques. Je m’engage à créer des designs uniques et impactants qui donnent vie à vos idées.",
  },
  buttons: [
    {
      name: "Contact",
...
export const navLinks = [
  ...
  { de: "About me", en: "À propos", hash: "#about-me", icon: GoPerson },
...
export const sideBarRightMail = {
  link: "https://www.instagram.com/achraf.souissi.design/",
  text: "Instagram",
} as const;
...
export const sideBarLeftSocials = [
  ...
  {
    link: "https://wa.me/212708901673?text=bonjour",
    icon: FiPhoneCall,
    altimgname: "Whatsapp",
  },
  {
    link: "mailto:contact.achraf.souissi@gmail.com",
    icon: FiMail,
    altimgname: "mail",
  },
] as const;
...
export const quotesData = [
  {
    ...
    en: `"Il n'est pas du tout important de réussir du premier coup. Ce qui est vraiment important, c'est de réussir à la dernière tentative."`,
    author: "Andrew Hunt",
  },
  {
